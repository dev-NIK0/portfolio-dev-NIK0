...
export const Front = () => {
  return (
    <div class="bg-indigo-500 m-30 h-dvh rounded-4xl">
      <h1 class="text-center p-20 text-2xl font-mono italic">Frontend Apps</h1>
      <div class="grid grid-cols-3 gap-3 justify-items-center">
        <div class="flex flex-col items-center" >
          <h1 class="text-center pb-10">Nota de Autores</h1>
        ...
        <div class="flex flex-col items-center">
          <h1 class="text-center pb-10">Cambiar de Color</h1>
          <img
        ...
        <div class="flex flex-col items-center">
          <h1 class="text-center pb-10">Perritos Mundito</h1>
          <img
